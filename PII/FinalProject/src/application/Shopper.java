...
public class Shopper extends User{
	...
	private static int shopperSequence;
	...
	public void cancelCart(){
		...
		//need to make a function in the shopperManager and then call it in the inventory and then here
	//	this.inventory.emptyCart(this);
		//this.inventory.getShopperManager().getShopperCart().put(this, this.shoppingCart);
		//need to update shopper file as well
		//make the quantity back available
...
/*	*//**
	 * Saves the shopper's shopping cart
	 *//*
