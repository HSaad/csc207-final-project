...
public class Customer extends Shopper{
	...
	private ArrayList<ShippingInvoice> invoices; 
	 ...
	 */
//	public Customer(String userID, String pw, String firstN, String lastN, String street, String city, String email, String phoneNumber, Inventory inventory, String creditCardNumber, String creditCardExpiryDate) {
//		super(userID, pw);	// shopping cart made in super class
//		this.invoices = new ArrayList<ShippingInvoice>();
//		this.firstName = firstN;
//		this.lastName = lastN;	
//		this.street = street;
//		this.city = city;	// separate address and city 
//		this.email = email;
//		this.phoneNumber = phoneNumber;
//		this.inventory = inventory;
//		this.creditCardExpiryDate = creditCardExpiryDate;
//		this.creditCardNumber = creditCardNumber;
//		this.inventory.addShopper(this);
//	}
	...
	public void addInvoice(ShippingInvoice shippingInvoice) {
		if (this.invoices.size() > 0) {
			if(!this.invoices.contains(shippingInvoice)){
				...
				//update file
				//this.inventory.addInvoice(this, shippingInvoice);
			}
		}
		else {
			this.invoices.add(shippingInvoice);
			//update file
			//this.s.addInvoice(this, shippingInvoice);
		}
	}
	
	/**
	 * This method saves the customer's shopping cart
	 */
	//delete save cart bc it's in the shopper. before delete check it's in shopper class
	//save a shopping cart but the quantity becomes available to others
/*	public void saveCart(){
		this.inventory.saveCart(this);
		//need to update the shopper file
	}*/
